...
import HijaiyahDhad from "./HijaiyahDhad";

export default function HijaiyahShad() {
    const navigation=useNavigation();

    function KlikBack(){
        navigation.navigate('HijaiyahSyin');
    }
    function KlikNext(){
        navigation.navigate('HijaiyahDhad',{HijaiyahDhad});
    }
