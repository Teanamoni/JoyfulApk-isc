...
import HijaiyahGhain from "./HijaiyahGhain";

export default function HijaiyahAin() {
    const navigation=useNavigation();

    function KlikBack(){
        navigation.navigate('HijaiyahZha');
    }
    function KlikNext(){
        navigation.navigate('HijaiyahGhain',{HijaiyahGhain});
    }
