...
import HijaiyahHamzah from "./HijaiyahHamzah";

export default function HijaiyahLamAlif() {
    const navigation=useNavigation();

    function KlikBack(){
        navigation.navigate('HijaiyahHak');
    }
    function KlikNext(){
        navigation.navigate('HijaiyahHamzah',{HijaiyahHamzah});
    }
