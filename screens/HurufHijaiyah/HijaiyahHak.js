...
import HijaiyahLamAlif from "./HijaiyahLamAlif";

export default function HijaiyahHak() {
    const navigation=useNavigation();

    function KlikBack(){
        navigation.navigate('HijaiyahWaw');
    }
    function KlikNext(){
        navigation.navigate('HijaiyahLamAlif',{HijaiyahLamAlif});
    }
